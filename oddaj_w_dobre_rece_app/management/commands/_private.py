...
def create_user():
    ...
    return password, last_login, last_name, first_name, is_superuser, email, is_staff, is_active, date_joined


def create_users():
    for user in range(0, 30):
        password, last_login, last_name, first_name, is_superuser, email, is_staff, is_active, date_joined = create_user()
        User.objects.create(
